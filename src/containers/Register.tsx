...
const Register = (props: MapState & Props) => {
	...
	const decideStep = () => {
		switch (true) {
			case Object.keys(props.formInformation.personal).length === 4 && page === 0:
				return setPage(1);
			case Object.keys(props.formInformation.address).length === 5 && page === 1:
				return setPage(2);
			default:
				break;
		}
...
const mapDispatch = (dispatch: any) => ({
	getpersonalInformation: (payload: any) => dispatch.formInformation.getpersonalInformation(payload),
	getAddressInformation: (payload: any) => dispatch.formInformation.getAddressInformation(payload),
	getPaymentInformation: (payload: any) => dispatch.formInformation.getPaymentInformation(payload),
});
